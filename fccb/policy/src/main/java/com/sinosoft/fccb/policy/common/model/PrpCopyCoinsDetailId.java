...
/**
 * PrpCopyCoinsDetailId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyCoinsDetailId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyCoinsDetailId))
			return false;
		PrpCopyCoinsDetailId castOther = (PrpCopyCoinsDetailId) other;
