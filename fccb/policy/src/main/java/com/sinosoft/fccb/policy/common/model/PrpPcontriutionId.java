...
/**
 * PrpPcontriutionId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPcontriutionId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpPcontriutionId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPcontriutionId))
			return false;
		PrpPcontriutionId castOther = (PrpPcontriutionId) other;
