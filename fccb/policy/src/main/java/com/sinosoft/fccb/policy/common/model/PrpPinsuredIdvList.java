...
/**
 * PrpPinsuredIdvList generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prppinsuredidvlist")
public class PrpPinsuredIdvList implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpPinsuredIdvListId id;
	/** 批单申请号 */
	...
	public PrpPinsuredIdvListId getId() {
		return this.id;
	}

	public void setId(PrpPinsuredIdvListId id) {
		this.id = id;
	}
