...
/**
 * PrpPinsuredArtifId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPinsuredArtifId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpPinsuredArtifId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPinsuredArtifId))
			return false;
		PrpPinsuredArtifId castOther = (PrpPinsuredArtifId) other;
