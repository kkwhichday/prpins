...
/**
 * PrpPitemCarExtId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPitemCarExtId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpPitemCarExtId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPitemCarExtId))
			return false;
		PrpPitemCarExtId castOther = (PrpPitemCarExtId) other;
