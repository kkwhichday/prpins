...
/**
 * PrpCopyContriution generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpcopycontriution")
public class PrpCopyContriution implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpCopyContriutionId id;
	/** 批单申请号 */
	...
	public PrpCopyContriutionId getId() {
		return this.id;
	}

	public void setId(PrpCopyContriutionId id) {
		this.id = id;
	}
