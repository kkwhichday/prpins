...
/**
 * PrpPitemTravelAgencyId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPitemTravelAgencyId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpPitemTravelAgencyId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPitemTravelAgencyId))
			return false;
		PrpPitemTravelAgencyId castOther = (PrpPitemTravelAgencyId) other;
