 ...
 */
@Embeddable
public class PrpCopyItemAgriId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpCopyItemAgriId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyItemAgriId))
			return false;
		PrpCopyItemAgriId castOther = (PrpCopyItemAgriId) other;
