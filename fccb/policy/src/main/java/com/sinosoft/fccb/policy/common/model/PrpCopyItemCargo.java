...
/**
 * PrpCopyItemCargo generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpcopyitem_cargo")
public class PrpCopyItemCargo implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 行号 */
	private PrpCopyItemCargoId id;
	/** 标的序号 */
	...
	public PrpCopyItemCargoId getId() {
		return this.id;
	}

	public void setId(PrpCopyItemCargoId id) {
		this.id = id;
	}
