 ...
 */
@Embeddable
public class PrpPclauseplanId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpPclauseplanId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPclauseplanId))
			return false;
		PrpPclauseplanId castOther = (PrpPclauseplanId) other;
