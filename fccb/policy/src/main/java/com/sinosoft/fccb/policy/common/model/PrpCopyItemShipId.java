...
/**
 * PrpCopyItemShipId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyItemShipId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpCopyItemShipId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyItemShipId))
			return false;
		PrpCopyItemShipId castOther = (PrpCopyItemShipId) other;
