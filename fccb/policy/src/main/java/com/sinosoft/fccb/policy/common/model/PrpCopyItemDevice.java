...
/**
 * PrpCopyItemDevice generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpcopyitem_device")
public class PrpCopyItemDevice implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 标的序号 */
	private PrpCopyItemDeviceId id;
	/** 标的序号 */
	...
	public PrpCopyItemDeviceId getId() {
		return this.id;
	}

	public void setId(PrpCopyItemDeviceId id) {
		this.id = id;
	}
