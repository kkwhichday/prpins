...
@Embeddable
public class PrpCinsuredCreditInvestId implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	private String proposalNo;
	private Integer serialNo;

	public PrpCinsuredCreditInvestId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCinsuredCreditInvestId))
			return false;
		PrpCinsuredCreditInvestId castOther = (PrpCinsuredCreditInvestId) other;
