...
/**
 * PrpCopyAnimal generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpcopyanimal")
public class PrpCopyAnimal implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 序号 */
	private PrpCopyAnimalId id;
	/** 当前保单号 */
	...
	public PrpCopyAnimalId getId() {
		return this.id;
	}

	public void setId(PrpCopyAnimalId id) {
		this.id = id;
	}
