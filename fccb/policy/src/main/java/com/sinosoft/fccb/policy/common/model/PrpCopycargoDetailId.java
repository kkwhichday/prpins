...
/**
 * PrpCopycargoDetailId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopycargoDetailId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopycargoDetailId))
			return false;
		PrpCopycargoDetailId castOther = (PrpCopycargoDetailId) other;
		...
		return ((this.getApplyNo() == castOther.getApplyNo()) || (this
				...
				&& ((this.getBatchNo() == castOther.getBatchNo()) || (this
						.getBatchNo() != null
						&& castOther.getBatchNo() != null && this.getBatchNo()
						.equals(castOther.getBatchNo())))
