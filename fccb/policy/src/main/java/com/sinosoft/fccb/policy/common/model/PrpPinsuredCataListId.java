...
@Embeddable
public class PrpPinsuredCataListId implements java.io.Serializable{
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPinsuredIdvListId))
			return false;
		PrpPinsuredIdvListId castOther = (PrpPinsuredIdvListId) other;
