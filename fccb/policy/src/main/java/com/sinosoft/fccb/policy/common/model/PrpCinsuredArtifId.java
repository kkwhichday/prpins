...
/**
 * PrpCinsuredArtifId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCinsuredArtifId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String proposalNo;
	private Integer serialNo;

	public PrpCinsuredArtifId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCinsuredArtifId))
			return false;
		PrpCinsuredArtifId castOther = (PrpCinsuredArtifId) other;
