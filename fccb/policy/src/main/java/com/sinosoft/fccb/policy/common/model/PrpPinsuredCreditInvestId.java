...
@Embeddable
public class PrpPinsuredCreditInvestId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpPinsuredCreditInvestId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPinsuredCreditInvestId))
			return false;
		PrpPinsuredCreditInvestId castOther = (PrpPinsuredCreditInvestId) other;
