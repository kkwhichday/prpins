...
/**
 * PrpPpayeeAccountId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPpayeeAccountId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpPpayeeAccountId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPpayeeAccountId))
			return false;
		PrpPpayeeAccountId castOther = (PrpPpayeeAccountId) other;
