...
/**
 * PrpPitemOilId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPitemOilId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpPitemOilId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPitemOilId))
			return false;
		PrpPitemOilId castOther = (PrpPitemOilId) other;
