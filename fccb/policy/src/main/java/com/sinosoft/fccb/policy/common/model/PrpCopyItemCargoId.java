...
/**
 * PrpCopyItemCargoId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyItemCargoId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyItemCargoId))
			return false;
		PrpCopyItemCargoId castOther = (PrpCopyItemCargoId) other;
