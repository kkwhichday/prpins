...
/**
 * PrpCopyRation generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpcopyration")
public class PrpCopyRation implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 投保方式代码 */
	private PrpCopyRationId id;
	 /** 批单申请号 */
...
//	private String rationName;
	...
	public PrpCopyRationId getId() {
		return this.id;
	}

	public void setId(PrpCopyRationId id) {
		this.id = id;
	}
