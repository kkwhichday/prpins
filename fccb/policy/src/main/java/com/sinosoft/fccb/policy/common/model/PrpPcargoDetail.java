 ...
 */
@Entity
@Table(name = "prppcargodetail")
public class PrpPcargoDetail implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpPcargoDetailId id;
	/** 批单申请号 */
	...
	public PrpPcargoDetailId getId() {
		return this.id;
	}

	public void setId(PrpPcargoDetailId id) {
		this.id = id;
	}
