...
/**
 * PrpcopycommissiondetailId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyCommissionDetailId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpCopyCommissionDetailId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyCommissionDetailId))
			return false;
		PrpCopyCommissionDetailId castOther = (PrpCopyCommissionDetailId) other;
