...
/**
 * PrpCopyStampTaxId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyStampTaxId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpCopyStampTaxId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyStampTaxId))
			return false;
		PrpCopyStampTaxId castOther = (PrpCopyStampTaxId) other;
