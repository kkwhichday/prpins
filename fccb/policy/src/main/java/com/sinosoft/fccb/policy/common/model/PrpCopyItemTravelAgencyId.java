...
/**
 * PrpCopyItemTravelAgencyId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyItemTravelAgencyId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpCopyItemTravelAgencyId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyItemTravelAgencyId))
			return false;
		PrpCopyItemTravelAgencyId castOther = (PrpCopyItemTravelAgencyId) other;
