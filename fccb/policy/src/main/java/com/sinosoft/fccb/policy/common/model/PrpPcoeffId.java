...
/**
 * PrpPcoeffId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPcoeffId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPcoeffId))
			return false;
		PrpPcoeffId castOther = (PrpPcoeffId) other;
