...
/**
 * PrpPitemCargo generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prppitem_cargo")
public class PrpPitemCargo implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 行号 */
	private PrpPitemCargoId id;
	/** 批单申请号 */
	...
	public PrpPitemCargoId getId() {
		return this.id;
	}

	public void setId(PrpPitemCargoId id) {
		this.id = id;
	}
