...
/**
 * Prpcopyagentdetail generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpcopyagentdetail")
public class PrpCopyAgentDetail implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 险别代码 */
	private PrpCopyAgentDetailId id;
	/** 批单申请号 */
	...
	public PrpCopyAgentDetailId getId() {
		return this.id;
	}

	public void setId(PrpCopyAgentDetailId id) {
		this.id = id;
	}
	/**       
	 * 批单申请号
