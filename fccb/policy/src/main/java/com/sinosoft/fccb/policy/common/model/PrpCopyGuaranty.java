...
/**
 * PrpCopyGuaranty generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpcopyguaranty")
public class PrpCopyGuaranty implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpCopyGuarantyId id;
	/** 批单申请号 */
	...
	public PrpCopyGuarantyId getId() {
		return this.id;
	}

	public void setId(PrpCopyGuarantyId id) {
		this.id = id;
	}
