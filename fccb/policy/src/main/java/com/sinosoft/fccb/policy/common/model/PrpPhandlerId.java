...
/**
 * PrpPhandlerId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPhandlerId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private String handlerCode;

	public PrpPhandlerId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPhandlerId))
			return false;
		PrpPhandlerId castOther = (PrpPhandlerId) other;
