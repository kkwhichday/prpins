...
/**
 * PrpPname generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prppname")
public class PrpPname implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpPnameId id;
	/** 批单申请号 */
	...
	public PrpPnameId getId() {
		return this.id;
	}

	public void setId(PrpPnameId id) {
		this.id = id;
	}
