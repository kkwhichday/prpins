...
/**
 * PrpPcoinsDetail generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prppcoinsdetail")
public class PrpPcoinsDetail implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 序号 */
	private PrpPcoinsDetailId id;
	/** 批单申请号 */
	...
	public PrpPcoinsDetailId getId() {
		return this.id;
	}

	public void setId(PrpPcoinsDetailId id) {
		this.id = id;
	}
