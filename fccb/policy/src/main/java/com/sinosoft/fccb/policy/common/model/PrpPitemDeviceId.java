...
/**
 * PrpPitemDeviceId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPitemDeviceId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpPitemDeviceId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPitemDeviceId))
			return false;
		PrpPitemDeviceId castOther = (PrpPitemDeviceId) other;
