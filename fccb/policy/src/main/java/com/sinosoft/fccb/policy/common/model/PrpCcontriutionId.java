...
/**
 * PrpCcontriutionId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCcontriutionId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String proposalNo;
	private Integer serialNo;

	public PrpCcontriutionId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCcontriutionId))
			return false;
		PrpCcontriutionId castOther = (PrpCcontriutionId) other;
