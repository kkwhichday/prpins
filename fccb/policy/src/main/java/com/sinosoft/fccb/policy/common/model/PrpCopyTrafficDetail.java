...
/**
 * PrpCopyTrafficDetail generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpcopytrafficdetail")
public class PrpCopyTrafficDetail implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 批单申请号 */
	private PrpCopyTrafficDetailId id;
	/** 标的序号 */
	...
	public PrpCopyTrafficDetailId getId() {
		return this.id;
	}

	public void setId(PrpCopyTrafficDetailId id) {
		this.id = id;
	}
