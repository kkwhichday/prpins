...
/**
 * PrpPcarDeviceId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPcarDeviceId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPcarDeviceId))
			return false;
		PrpPcarDeviceId castOther = (PrpPcarDeviceId) other;
