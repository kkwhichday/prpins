...
/**
 * PrpPtrafficDetail generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpptrafficdetail")
public class PrpPtrafficDetail implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpPtrafficDetailId id;
	/** 标的序号 */
	private PrpPitemCarExt prpPitemCarExt;
	/** 批单号 */
	...
	public PrpPtrafficDetailId getId() {
		return this.id;
	}

	public void setId(PrpPtrafficDetailId id) {
		this.id = id;
	}
	...
	public PrpPitemCarExt getPrpPitemCarExt() {
		return this.prpPitemCarExt;
	}

	public void setPrpPitemCarExt(PrpPitemCarExt prpPitemCarExt) {
		this.prpPitemCarExt = prpPitemCarExt;
	}
