...
/**
 * PrpCopyCarDeviceId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyCarDeviceId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyCarDeviceId))
			return false;
		PrpCopyCarDeviceId castOther = (PrpCopyCarDeviceId) other;
