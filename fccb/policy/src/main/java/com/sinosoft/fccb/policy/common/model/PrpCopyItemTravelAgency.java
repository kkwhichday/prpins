...
/**
 * PrpCopyItemTravelAgency generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpcopyitem_travelagency")
public class PrpCopyItemTravelAgency implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 标的序号 */
	private PrpCopyItemTravelAgencyId id;
	/** 标的序号 */
	...
	public PrpCopyItemTravelAgency() {
	}
	...
	public PrpCopyItemTravelAgencyId getId() {
		return this.id;
	}

	public void setId(PrpCopyItemTravelAgencyId id) {
		this.id = id;
	}
