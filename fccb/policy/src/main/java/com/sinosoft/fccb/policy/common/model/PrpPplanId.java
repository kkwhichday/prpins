...
/**
 * PrpPplanId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPplanId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPplanId))
			return false;
		PrpPplanId castOther = (PrpPplanId) other;
