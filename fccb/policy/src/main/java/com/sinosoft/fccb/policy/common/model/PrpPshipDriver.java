...
/**
 * PrpPshipDriver generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prppshipdriver")
public class PrpPshipDriver implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpPshipDriverId id;
	/** 批单申请号 */
	...
	public PrpPshipDriverId getId() {
		return this.id;
	}

	public void setId(PrpPshipDriverId id) {
		this.id = id;
	}
