...
/**
 * PrpCopyAddress generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpcopyaddress")
public class PrpCopyAddress implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 地址序号 */
	private PrpCopyAddressId id;
	/** 批单申请号 */
	...
	public PrpCopyAddressId getId() {
		return this.id;
	}

	public void setId(PrpCopyAddressId id) {
		this.id = id;
	}
