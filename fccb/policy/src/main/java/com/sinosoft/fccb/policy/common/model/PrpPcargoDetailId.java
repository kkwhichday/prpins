 ...
 */
@Embeddable
public class PrpPcargoDetailId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPcargoDetailId))
			return false;
		PrpPcargoDetailId castOther = (PrpPcargoDetailId) other;
