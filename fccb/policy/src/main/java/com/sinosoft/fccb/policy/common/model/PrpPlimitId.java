...
/**
 * PrpPlimitId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPlimitId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPlimitId))
			return false;
		PrpPlimitId castOther = (PrpPlimitId) other;
