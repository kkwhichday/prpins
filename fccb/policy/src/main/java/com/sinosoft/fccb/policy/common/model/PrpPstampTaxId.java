...
/**
 * PrpPstampTaxId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPstampTaxId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpPstampTaxId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPstampTaxId))
			return false;
		PrpPstampTaxId castOther = (PrpPstampTaxId) other;
