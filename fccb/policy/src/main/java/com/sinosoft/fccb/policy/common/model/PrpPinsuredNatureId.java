...
/**
 * PrpPinsuredNatureId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPinsuredNatureId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpPinsuredNatureId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPinsuredNatureId))
			return false;
		PrpPinsuredNatureId castOther = (PrpPinsuredNatureId) other;
