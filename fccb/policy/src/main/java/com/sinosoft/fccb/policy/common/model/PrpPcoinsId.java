...
/**
 * PrpPcoinsId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPcoinsId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPcoinsId))
			return false;
		PrpPcoinsId castOther = (PrpPcoinsId) other;
