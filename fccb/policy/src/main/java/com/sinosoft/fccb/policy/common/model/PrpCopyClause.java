 ...
 */
@Entity
@Table(name = "prpcopyclause")
public class PrpCopyClause implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpCopyClauseId id;
	/** 批单申请号 */
	...
	public PrpCopyClauseId getId() {
		return this.id;
	}

	public void setId(PrpCopyClauseId id) {
		this.id = id;
	}
