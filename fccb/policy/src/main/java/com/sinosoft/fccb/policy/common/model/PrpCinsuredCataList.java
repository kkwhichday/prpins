...
@Entity
@Table(name = "prpcinsuredcatalist")
public class PrpCinsuredCataList implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpCinsuredCataListId id;
	/** 汇交单小保单号 */
...
//	private String raiseAddress;
	...
	public PrpCinsuredCataListId getId() {
		return this.id;
	}

	public void setId(PrpCinsuredCataListId id) {
		this.id = id;
	}
