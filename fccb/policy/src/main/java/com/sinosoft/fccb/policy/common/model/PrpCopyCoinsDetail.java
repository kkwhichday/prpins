...
/**
 * PrpCopyCoinsDetail generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpcopycoinsdetail")
public class PrpCopyCoinsDetail implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 序号 */
	private PrpCopyCoinsDetailId id;
	/** 批单申请号 */
	...
	public PrpCopyCoinsDetailId getId() {
		return this.id;
	}

	public void setId(PrpCopyCoinsDetailId id) {
		this.id = id;
	}
