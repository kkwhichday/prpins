 ...
 */
@Embeddable
public class PrpPitemAnimalId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpPitemAnimalId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPitemAnimalId))
			return false;
		PrpPitemAnimalId castOther = (PrpPitemAnimalId) other;
