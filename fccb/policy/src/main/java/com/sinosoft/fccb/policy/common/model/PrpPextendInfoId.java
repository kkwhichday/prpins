...
/**
 * PrpPextendInfoId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPextendInfoId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPextendInfoId))
			return false;
		PrpPextendInfoId castOther = (PrpPextendInfoId) other;
