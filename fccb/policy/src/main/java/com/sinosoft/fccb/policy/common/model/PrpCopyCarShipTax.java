...
/**
 * PrpCopyCarShipTax generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpcopycarshiptax")
public class PrpCopyCarShipTax implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 标的序号 */
	private PrpCopyCarShipTaxId id;
	/** 批单申请号 */
	...
	public PrpCopyCarShipTaxId getId() {
		return this.id;
	}

	public void setId(PrpCopyCarShipTaxId id) {
		this.id = id;
	}
