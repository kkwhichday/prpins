package com.sinosoft.fccb.policy.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "prpinsEntityManagerFactory", transactionManagerRef = "prpinsTransactionManager", basePackages = { "com.sinosoft.fccb.policy" })
...
//prpcitem_device; prpcprofitdetail prpcitem_plane prpcprofitfactor  以及copy,p表 mysql关键字冲突

        return builder.dataSource(dataSource)
                .properties(jpaProperties)
                .packages("com.sinosoft.fccb.policy")
                .build();
    }
