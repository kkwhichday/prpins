...
/**
 * PrpPitemId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPitemId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPitemId))
			return false;
		PrpPitemId castOther = (PrpPitemId) other;
