...
/**
 * PrpCopyDeductionId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyDeductionId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyDeductionId))
			return false;
		PrpCopyDeductionId castOther = (PrpCopyDeductionId) other;
