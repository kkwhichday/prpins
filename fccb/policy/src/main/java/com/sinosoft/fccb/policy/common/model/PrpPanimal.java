...
/**
 * PrpPanimal generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prppanimal")
public class PrpPanimal implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 序号 */
	private PrpPanimalId id;
	/** 批单号 */
	...
	public PrpPanimalId getId() {
		return this.id;
	}

	public void setId(PrpPanimalId id) {
		this.id = id;
	}
