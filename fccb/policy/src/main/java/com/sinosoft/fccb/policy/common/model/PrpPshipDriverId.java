...
/**
 * PrpPshipDriverId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPshipDriverId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpPshipDriverId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPshipDriverId))
			return false;
		PrpPshipDriverId castOther = (PrpPshipDriverId) other;
