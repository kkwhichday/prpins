 ...
 */
@Entity
@Table(name = "prppitem_animal")
public class PrpPitemAnimal implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 标的序号 */
	private PrpPitemAnimalId id;
	/** 批单申请号 */
	...
	public PrpPitemAnimalId getId() {
		return this.id;
	}

	public void setId(PrpPitemAnimalId id) {
		this.id = id;
	}
