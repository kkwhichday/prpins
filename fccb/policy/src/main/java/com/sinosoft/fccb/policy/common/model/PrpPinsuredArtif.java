...
/**
 * PrpPinsuredArtif generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prppinsuredartif")
public class PrpPinsuredArtif implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpPinsuredArtifId id;
	/** 批单申请号 */
	...
	public PrpPinsuredArtifId getId() {
		return this.id;
	}

	public void setId(PrpPinsuredArtifId id) {
		this.id = id;
	}
