...
@Entity
@Table(name = "prpcinsuredcreditinvest")
public class PrpCinsuredCreditInvest implements java.io.Serializable{
	private static final long serialVersionUID = 1L;
	private PrpCinsuredCreditInvestId id;
	...
	public PrpCinsuredCreditInvestId getId() {
		return id;
	}
	public void setId(PrpCinsuredCreditInvestId id) {
		this.id = id;
	}
	/**       
	 * SerialNo
