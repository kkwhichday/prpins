...
/**
 * PrpPitemAgriId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPitemAgriRelatedId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpPitemAgriRelatedId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPitemAgriRelatedId))
			return false;
		PrpPitemAgriRelatedId castOther = (PrpPitemAgriRelatedId) other;
