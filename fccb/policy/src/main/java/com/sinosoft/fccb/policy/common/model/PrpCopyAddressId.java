...
/**
 * PrpCopyAddressId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyAddressId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer addressNo;

	public PrpCopyAddressId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyAddressId))
			return false;
		PrpCopyAddressId castOther = (PrpCopyAddressId) other;
