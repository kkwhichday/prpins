 ...
 */
@Embeddable
public class PrpCopyItemAnimalId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpCopyItemAnimalId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyItemAnimalId))
			return false;
		PrpCopyItemAnimalId castOther = (PrpCopyItemAnimalId) other;
