...
/**
 * PrpPinsuredIdvListNature generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prppinsuredidvlistnature")
public class PrpPinsuredIdvListNature implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	public PrpPinsuredIdvListNatureId id;
	/** 批单申请号 */
	...
	public PrpPinsuredIdvListNature() {
	}
	...
	public PrpPinsuredIdvListNatureId getId() {
		return this.id;
	}

	public void setId(PrpPinsuredIdvListNatureId id) {
		this.id = id;
	}
