...
/**
 * PrpcopyagentId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyAgentId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyAgentId))
			return false;
		PrpCopyAgentId castOther = (PrpCopyAgentId) other;
