...
/**
 * PrpCitemKindDetailId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCitemKindDetailId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCitemKindDetailId))
			return false;
		PrpCitemKindDetailId castOther = (PrpCitemKindDetailId) other;
