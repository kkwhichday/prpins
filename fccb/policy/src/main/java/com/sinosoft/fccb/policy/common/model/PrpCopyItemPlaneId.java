...
/**
 * PrpCopyItemPlaneId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyItemPlaneId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpCopyItemPlaneId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyItemPlaneId))
			return false;
		PrpCopyItemPlaneId castOther = (PrpCopyItemPlaneId) other;
