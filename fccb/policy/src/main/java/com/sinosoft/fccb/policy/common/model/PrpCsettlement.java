...
public class PrpCsettlement implements java.io.Serializable {
	...
	/** 采购方单位级别 */
	private BigDecimal buyerUnitRank;
	/** 采购方上级主管代码 */
	...
	/** 采购预算 */
	private BigDecimal buyerPreFee;
	/** 资金构成 */
	...
	public BigDecimal getBuyerUnitRank() {
		return this.buyerUnitRank;
	}

	public void setBuyerUnitRank(BigDecimal buyerUnitRank) {
	...
	public BigDecimal getBuyerPreFee() {
		return this.buyerPreFee;
	}

	public void setBuyerPreFee(BigDecimal buyerPreFee) {
