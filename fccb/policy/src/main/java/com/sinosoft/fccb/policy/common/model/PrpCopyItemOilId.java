...
/**
 * PrpCopyItemOilId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyItemOilId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpCopyItemOilId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyItemOilId))
			return false;
		PrpCopyItemOilId castOther = (PrpCopyItemOilId) other;
