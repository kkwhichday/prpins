...
@Embeddable
public class PrpCopyItemCreditOthId implements java.io.Serializable{
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpCopyItemCreditOthId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyItemCreditOthId))
			return false;
		PrpCopyItemCreditOthId castOther = (PrpCopyItemCreditOthId) other;
