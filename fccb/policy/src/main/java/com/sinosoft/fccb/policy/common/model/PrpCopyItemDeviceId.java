...
/**
 * PrpCopyItemDeviceId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyItemDeviceId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpCopyItemDeviceId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyItemDeviceId))
			return false;
		PrpCopyItemDeviceId castOther = (PrpCopyItemDeviceId) other;
