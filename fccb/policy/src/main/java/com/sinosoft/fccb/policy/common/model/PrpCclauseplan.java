 ...
 */
@Entity
@Table(name = "prpcclauseplan")
public class PrpCclauseplan implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 顺序号 */
	private PrpCclauseplanId id;
	/** 投保单号码 */
	...
	public PrpCclauseplanId getId() {
		return id;
	}

	public void setId(PrpCclauseplanId id) {
		this.id = id;
	}
