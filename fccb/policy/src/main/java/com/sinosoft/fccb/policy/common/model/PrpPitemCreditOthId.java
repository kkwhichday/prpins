...
@Embeddable
public class PrpPitemCreditOthId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpPitemCreditOthId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPitemCreditOthId))
			return false;
		PrpPitemCreditOthId castOther = (PrpPitemCreditOthId) other;
