...
/**
 * PrpCopyBatchId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyBatchId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpCopyBatchId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyBatchId))
			return false;
		PrpCopyBatchId castOther = (PrpCopyBatchId) other;
