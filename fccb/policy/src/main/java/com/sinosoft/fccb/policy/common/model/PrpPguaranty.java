...
/**
 * PrpPguaranty generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prppguaranty")
public class PrpPguaranty implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpPguarantyId id;
	/** 批单申请号 */
	...
	public PrpPguarantyId getId() {
		return this.id;
	}

	public void setId(PrpPguarantyId id) {
		this.id = id;
	}
