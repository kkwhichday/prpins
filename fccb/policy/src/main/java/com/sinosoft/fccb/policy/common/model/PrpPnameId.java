...
/**
 * PrpPnameId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPnameId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPnameId))
			return false;
		PrpPnameId castOther = (PrpPnameId) other;
