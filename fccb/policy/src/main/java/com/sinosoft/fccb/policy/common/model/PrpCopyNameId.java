...
/**
 * PrpCopyNameId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyNameId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpCopyNameId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyNameId))
			return false;
		PrpCopyNameId castOther = (PrpCopyNameId) other;
