...
/**
 * PrpCopyCarModelId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyCarModelId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpCopyCarModelId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyCarModelId))
			return false;
		PrpCopyCarModelId castOther = (PrpCopyCarModelId) other;
