 ...
 */
@Entity
@Table(name = "prpcopyseller")
public class PrpCopySeller implements java.io.Serializable {

	private PrpCopysellerId id;
	...
	/** default constructor */
	public PrpCopySeller() {
	}

	/** minimal constructor */
	public PrpCopySeller(PrpCopysellerId id, String policyno, String sellername,
	...
	/** full constructor */
	public PrpCopySeller(PrpCopysellerId id, String policyno, String chgfeeno,
	...
	public PrpCopysellerId getId() {
		return this.id;
	}

	public void setId(PrpCopysellerId id) {
		this.id = id;
	}
