...
/**
 * PrpCopyProfitFactorId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyProfitFactorId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyProfitFactorId))
			return false;
		PrpCopyProfitFactorId castOther = (PrpCopyProfitFactorId) other;
