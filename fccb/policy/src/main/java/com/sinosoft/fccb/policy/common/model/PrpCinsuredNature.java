...
/**
 * PrpCinsuredNature generated by Tools.Don't edit.
 */
@Entity
...
public class PrpCinsuredNature implements java.io.Serializable {
	...
	@JoinColumns( {
			@JoinColumn(name = "proposalno", nullable = false, insertable = false, updatable = false,referencedColumnName="proposalno"),
