...
/**
 * PrpCopyitemKindDetailId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyItemKindDetailId implements java.io.Serializable {
	...
	public PrpCopyItemKindDetailId() {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyItemKindDetailId))
			return false;
		PrpCopyItemKindDetailId castOther = (PrpCopyItemKindDetailId) other;
