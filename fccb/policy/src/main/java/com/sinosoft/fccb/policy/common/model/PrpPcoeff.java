...
/**
 * PrpPcoeff generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prppcoeff")
public class PrpPcoeff implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpPcoeffId id;
	/** 批单申请号 */
	...
	private String flag;
	/** 系数保费变化量 */
	private BigDecimal chgCoeffPremium;
	/** 插入时间 */
	...
	public PrpPcoeffId getId() {
		return this.id;
	}

	public void setId(PrpPcoeffId id) {
		this.id = id;
	}
	...
	@Column(name = "chgcoeffpremium")
	public BigDecimal getChgCoeffPremium() {
		return this.chgCoeffPremium;
	}

	public void setChgCoeffPremium(BigDecimal chgCoeffPremium) {
		this.chgCoeffPremium = chgCoeffPremium;
	}
