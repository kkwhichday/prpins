...
/**
 * PrpCopyCoeffId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyCoeffId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpCopyCoeffId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyCoeffId))
			return false;
		PrpCopyCoeffId castOther = (PrpCopyCoeffId) other;
