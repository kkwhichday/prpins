...
/**
 * PrpPitemCar generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prppitem_car")
public class PrpPitemCar implements java.io.Serializable {
	...
	public String getVehicleCategorye() {
		return this.vehicleCategory;
	}

	public void setVehicleCategorye(String vehicleCategory) {
	...
	public String getLicenseFlagg() {
		return this.licenseFlag;
	}

	public void setLicenseFlagg(String licenseFlag) {
	...
	public String getMonopolyFlagg() {
		return this.monopolyFlag;
	}

	public void setMonopolyFlagg(String monopolyFlag) {
	...
	public String getMonopolyCodeg() {
		return this.monopolyCode;
	}

	public void setMonopolyCodeg(String monopolyCode) {
	...
	public String getNewCarFlagg() {
		return this.newCarFlag;
	}

	public void setNewCarFlagg(String newCarFlag) {
