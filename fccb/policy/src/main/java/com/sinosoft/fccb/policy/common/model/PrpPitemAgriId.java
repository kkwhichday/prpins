 ...
 */
@Embeddable
public class PrpPitemAgriId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpPitemAgriId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPitemAgriId))
			return false;
		PrpPitemAgriId castOther = (PrpPitemAgriId) other;
