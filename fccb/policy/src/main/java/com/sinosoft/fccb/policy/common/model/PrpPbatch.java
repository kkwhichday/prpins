...
/**
 * PrpPbatch generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prppbatch")
public class PrpPbatch implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpPbatchId id;
	/** 批单申请号 */
	...
	public PrpPbatchId getId() {
		return this.id;
	}

	public void setId(PrpPbatchId id) {
		this.id = id;
	}
