...
public class PrpCopyItemKind implements java.io.Serializable {
	...
	private List<PrpCopyProfit> prpCopyProfits = new ArrayList<PrpCopyProfit>(0);
	private List<PrpCopyItemKindDetail> prpCopyItemKindDetails = new ArrayList<PrpCopyItemKindDetail>(0);
	private List<PrpCopyItemKindTaxFee> prpCopyItemKindTaxFees = new ArrayList<PrpCopyItemKindTaxFee>(0);
	...
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "prpCopyItemKind")
	public List<PrpCopyProfit> getPrpCopyProfits() {
		return this.prpCopyProfits;
	}

	public void setPrpCopyProfits(List<PrpCopyProfit> prpCopyProfits) {
		this.prpCopyProfits = prpCopyProfits;
	}
    
	@OneToMany(cascade=CascadeType.ALL, fetch=FetchType.LAZY, mappedBy="prpCopyItemKind")   
	public List<PrpCopyItemKindDetail> getPrpCopyItemKindDetails() {
		return prpCopyItemKindDetails;
	}

	public void setPrpCopyItemKindDetails(
			List<PrpCopyItemKindDetail> prpCopyItemKindDetails) {
		this.prpCopyItemKindDetails = prpCopyItemKindDetails;
	}
	...
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "prpCopyItemKind")
	public List<PrpCopyItemKindTaxFee> getPrpCopyItemKindTaxFees() {
		return prpCopyItemKindTaxFees;
	}

	public void setPrpCopyItemKindTaxFees(
			List<PrpCopyItemKindTaxFee> prpCopyItemKindTaxFees) {
		this.prpCopyItemKindTaxFees = prpCopyItemKindTaxFees;
	}
