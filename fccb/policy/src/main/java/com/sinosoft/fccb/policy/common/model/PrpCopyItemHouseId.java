...
/**
 * PrpCopyItemHouseId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyItemHouseId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpCopyItemHouseId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyItemHouseId))
			return false;
		PrpCopyItemHouseId castOther = (PrpCopyItemHouseId) other;
