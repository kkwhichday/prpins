...
/**
 * PrpCopyItemPropId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyItemPropId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpCopyItemPropId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyItemPropId))
			return false;
		PrpCopyItemPropId castOther = (PrpCopyItemPropId) other;
