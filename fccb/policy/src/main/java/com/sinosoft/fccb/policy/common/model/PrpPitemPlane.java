...
/**
 * PrpPitemPlane generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prppitem_plane")
public class PrpPitemPlane implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 标的序号 */
	private PrpPitemPlaneId id;
	/** 批单申请号 */
	...
	public PrpPitemPlaneId getId() {
		return this.id;
	}

	public void setId(PrpPitemPlaneId id) {
		this.id = id;
	}
