...
@Entity
@Table(name = "prpcopyinsuredcreditinvest")
public class PrpCopyInsuredCreditInvest implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	private PrpCopyInsuredCreditInvestId id;
	...
	public PrpCopyInsuredCreditInvestId getId() {
		return id;
	}
	public void setId(PrpCopyInsuredCreditInvestId id) {
		this.id = id;
	}
