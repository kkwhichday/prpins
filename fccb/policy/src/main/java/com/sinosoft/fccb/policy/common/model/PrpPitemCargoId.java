...
/**
 * PrpPitemCargoId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPitemCargoId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPitemCargoId))
			return false;
		PrpPitemCargoId castOther = (PrpPitemCargoId) other;
