...
/**
 * PrpCopyCoinsId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyCoinsId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyCoinsId))
			return false;
		PrpCopyCoinsId castOther = (PrpCopyCoinsId) other;
