...
/**
 * PrpPitemShipId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPitemShipId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpPitemShipId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPitemShipId))
			return false;
		PrpPitemShipId castOther = (PrpPitemShipId) other;
