 ...
 */
@Entity
@Table(name = "prpcopyclausecontent")
public class PrpCopyClauseContent implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpCopyClauseContentId id;
	/** 批单申请号 */
	...
	public PrpCopyClauseContentId getId() {
		return this.id;
	}

	public void setId(PrpCopyClauseContentId id) {
		this.id = id;
	}
