...
/**
 * PrpPguarantyId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPguarantyId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpPguarantyId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPguarantyId))
			return false;
		PrpPguarantyId castOther = (PrpPguarantyId) other;
