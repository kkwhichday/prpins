...
/**
 * PrpCopyitemKindDetail generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpcopyitemkinddetail")
public class PrpCopyItemKindDetail implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	
	/** 序号 */
	private PrpCopyItemKindDetailId id;
	/** 保险责任序号 */
	...
	public PrpCopyItemKindDetailId getId() {
		return id;
	}

	public void setId(PrpCopyItemKindDetailId id) {
		this.id = id;
	}
