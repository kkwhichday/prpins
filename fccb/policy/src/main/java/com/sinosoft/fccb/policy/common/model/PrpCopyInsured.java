...
public class PrpCopyInsured implements java.io.Serializable {
	...
	private List<PrpCopyInsuredNature> prpCopyInsuredNatures = new ArrayList<PrpCopyInsuredNature>(
			0);
	private List<PrpCopyInsuredArtif> prpCopyInsuredArtifs = new ArrayList<PrpCopyInsuredArtif>(
			0);
	private List<PrpCopyInsuredCreditInvest> prpCopyInsuredCreditInvests = new ArrayList<PrpCopyInsuredCreditInvest>(
			0);
	...
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "prpCopyInsured")
	public List<PrpCopyInsuredNature> getPrpCopyInsuredNatures() {
		return this.prpCopyInsuredNatures;
	}

	public void setPrpCopyInsuredNatures(
			List<PrpCopyInsuredNature> prpCopyInsuredNatures) {
		this.prpCopyInsuredNatures = prpCopyInsuredNatures;
	}

	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "prpCopyInsured")
	public List<PrpCopyInsuredArtif> getPrpCopyInsuredArtifs() {
		return this.prpCopyInsuredArtifs;
	}

	public void setPrpCopyInsuredArtifs(
			List<PrpCopyInsuredArtif> prpCopyInsuredArtifs) {
		this.prpCopyInsuredArtifs = prpCopyInsuredArtifs;
	}
	
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "prpCopyInsured")
	public List<PrpCopyInsuredCreditInvest> getPrpCopyInsuredCreditInvests() {
		return prpCopyInsuredCreditInvests;
	}

	public void setPrpCopyInsuredCreditInvests(
			List<PrpCopyInsuredCreditInvest> prpCopyInsuredCreditInvests) {
		this.prpCopyInsuredCreditInvests = prpCopyInsuredCreditInvests;
	}
