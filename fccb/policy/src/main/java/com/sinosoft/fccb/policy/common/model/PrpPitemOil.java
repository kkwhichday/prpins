...
/**
 * PrpPitemOil generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prppitem_oil")
public class PrpPitemOil implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 标的序号 */
	private PrpPitemOilId id;
	/** 批单申请号 */
	...
	public PrpPitemOilId getId() {
		return this.id;
	}

	public void setId(PrpPitemOilId id) {
		this.id = id;
	}
