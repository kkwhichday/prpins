...
/**
 * PrpCopycargoDetail generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpcopycargodetail")
public class PrpCopycargoDetail implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpCopycargoDetailId id;
	/** 批单申请号 */
	...
	public PrpCopycargoDetailId getId() {
		return this.id;
	}

	public void setId(PrpCopycargoDetailId id) {
		this.id = id;
	}
