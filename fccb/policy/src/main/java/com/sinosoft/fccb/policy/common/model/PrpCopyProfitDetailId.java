...
/**
 * PrpCopyProfitDetailId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyProfitDetailId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyProfitDetailId))
			return false;
		PrpCopyProfitDetailId castOther = (PrpCopyProfitDetailId) other;
