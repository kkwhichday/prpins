...
/**
 * PrpCopyShipDriverId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyShipDriverId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpCopyShipDriverId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyShipDriverId))
			return false;
		PrpCopyShipDriverId castOther = (PrpCopyShipDriverId) other;
