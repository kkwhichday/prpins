...
/**
 * PrpCopyItemAgriId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyItemAgriRelatedId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpCopyItemAgriRelatedId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyItemAgriRelatedId))
			return false;
		PrpCopyItemAgriRelatedId castOther = (PrpCopyItemAgriRelatedId) other;
