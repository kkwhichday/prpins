...
public class PrpCardSub implements java.io.Serializable {
	...
	@EmbeddedId
	@AttributeOverrides( {
			@AttributeOverride(name = "businessNo", column = @Column(name = "businessno", nullable = false)),
			...
			@AttributeOverride(name = "payRefReason", column = @Column(name = "payrefreason", nullable = false)),
