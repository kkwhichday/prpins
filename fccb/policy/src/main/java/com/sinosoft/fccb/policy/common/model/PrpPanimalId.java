...
/**
 * PrpPanimalId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPanimalId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPanimalId))
			return false;
		PrpPanimalId castOther = (PrpPanimalId) other;
