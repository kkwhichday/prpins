...
/**
 * PrpPitemHouseId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPitemHouseId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpPitemHouseId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPitemHouseId))
			return false;
		PrpPitemHouseId castOther = (PrpPitemHouseId) other;
