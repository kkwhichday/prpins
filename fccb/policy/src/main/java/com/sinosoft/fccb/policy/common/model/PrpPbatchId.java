...
/**
 * PrpPbatchId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPbatchId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPbatchId))
			return false;
		PrpPbatchId castOther = (PrpPbatchId) other;
