...
/**
 * PrpPaddress generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prppaddress")
public class PrpPaddress implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 地址序号 */
	private PrpPaddressId id;
	/** 批单申请号 */
	...
	public PrpPaddressId getId() {
		return this.id;
	}

	public void setId(PrpPaddressId id) {
		this.id = id;
	}
