 ...
 */
@Embeddable
public class PrpCopyClauseplanId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpCopyClauseplanId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyClauseplanId))
			return false;
		PrpCopyClauseplanId castOther = (PrpCopyClauseplanId) other;
