 ...
 */
@Embeddable
public class PrpCopyEngageId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpCopyEngageId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyEngageId))
			return false;
		PrpCopyEngageId castOther = (PrpCopyEngageId) other;
