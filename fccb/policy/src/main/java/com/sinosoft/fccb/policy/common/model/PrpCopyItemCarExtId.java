...
/**
 * PrpCopyItemCarExtId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyItemCarExtId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpCopyItemCarExtId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyItemCarExtId))
			return false;
		PrpCopyItemCarExtId castOther = (PrpCopyItemCarExtId) other;
