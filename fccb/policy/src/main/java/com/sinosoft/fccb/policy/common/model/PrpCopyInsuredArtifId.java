...
/**
 * PrpCopyInsuredArtifId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyInsuredArtifId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpCopyInsuredArtifId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyInsuredArtifId))
			return false;
		PrpCopyInsuredArtifId castOther = (PrpCopyInsuredArtifId) other;
