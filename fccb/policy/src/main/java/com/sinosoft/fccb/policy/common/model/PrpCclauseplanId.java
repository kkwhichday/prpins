 ...
 */
@Embeddable
public class PrpCclauseplanId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String proposalNo;
	private Integer serialNo;

	public PrpCclauseplanId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCclauseplanId))
			return false;
		PrpCclauseplanId castOther = (PrpCclauseplanId) other;
