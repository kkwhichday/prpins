...
/**
 * PrpCopyName generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpcopyname")
public class PrpCopyName implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** SerialNo */
	private PrpCopyNameId id;
	/** 批单申请号 */
	...
	public PrpCopyNameId getId() {
		return this.id;
	}

	public void setId(PrpCopyNameId id) {
		this.id = id;
	}
