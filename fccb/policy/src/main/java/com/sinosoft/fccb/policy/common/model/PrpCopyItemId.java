...
/**
 * PrpCopyItemId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyItemId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer itemNo;

	public PrpCopyItemId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyItemId))
			return false;
		PrpCopyItemId castOther = (PrpCopyItemId) other;
