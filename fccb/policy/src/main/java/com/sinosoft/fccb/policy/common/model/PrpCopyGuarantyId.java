...
/**
 * PrpCopyGuarantyId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCopyGuarantyId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String applyNo;
	private Integer serialNo;

	public PrpCopyGuarantyId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCopyGuarantyId))
			return false;
		PrpCopyGuarantyId castOther = (PrpCopyGuarantyId) other;
