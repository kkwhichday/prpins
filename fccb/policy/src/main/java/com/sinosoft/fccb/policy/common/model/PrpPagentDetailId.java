...
/**
 * PrppagentdetailId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpPagentDetailId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpPagentDetailId))
			return false;
		PrpPagentDetailId castOther = (PrpPagentDetailId) other;
